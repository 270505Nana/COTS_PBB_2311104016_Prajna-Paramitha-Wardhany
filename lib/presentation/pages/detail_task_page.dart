...
import 'package:cots/models/task.dart';
// Import Controller
import 'package:cots/controllers/task_controller.dart';
import 'package:cots/presentation/widgets/custom_button.dart';
import 'package:cots/presentation/widgets/custom_textfield.dart';
...
class _DetailTaskPageState extends State<DetailTaskPage> {
  ...
  Future<void> _saveChanges() async {
    setState(() => _isLoading = true);
    try {
      // Menggunakan TaskController.updateStatus
      // Kita kirim ID, status checkbox, dan note (jika ada perubahan)
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text("Deadline", style: AppTextStyles.caption),
                          Text(
                            DateFormat('d MMM yyyy').format(widget.task.deadline),
                            style: AppTextStyles.section,
                          ),
                        ],
                      ),
